...
--Total Death Count per Continent and entries that are blank in the continent column
...
--Return continents with the highest death count per population
Select continent,MAX(CAST(total_deaths as int)) as TotalDeathCount
FROM PortfolioProject..CovidDeaths
WHERE continent IS Not NULL
Group By continent
...
--COVID VACCINATIONS
--Joining the COVID vaccination table
